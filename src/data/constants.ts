...
export const API_PRICING: APIPricing[] = [
  ...
  { model: 'Llama 4 Scout 109B', provider: 'DeepInfra',  input: 0.08, output: 0.30, cache: 0.50, path: 'aggregator', notes: 'Cheapest' },
  ...
  { model: 'Llama 4 Maverick 400B', provider: 'DeepInfra',   input: 0.15, output: 0.60, cache: 0.50, path: 'aggregator', notes: 'Cheapest' },
  ...
  // ── Llama 3.3 70B ─────────────────────────────────────────────────────────
  { model: 'Llama 3.3 70B', provider: 'DeepInfra',   input: 0.10, output: 0.32, cache: 0.50, path: 'aggregator', notes: 'Cheapest' },
  ...
  // ── Llama 3.1 8B ──────────────────────────────────────────────────────────
  { model: 'Llama 3.1 8B', provider: 'DeepInfra',   input: 0.02, output: 0.05, cache: 0.50, path: 'aggregator', notes: 'Cheapest' },
  ...
  // ── Qwen3 ─────────────────────────────────────────────────────────────────
  { model: 'Qwen3-235B',          provider: 'DeepInfra', input: 0.071, output: 0.10, cache: 0.50, path: 'aggregator', notes: 'Cheapest' },
  { model: 'Qwen3-235B',          provider: 'Fireworks', input: 1.20,  output: 1.20, cache: 0.50, path: 'aggregator' },
  { model: 'Qwen3-32B',           provider: 'DeepInfra', input: 0.08,  output: 0.28, cache: 0.50, path: 'aggregator', notes: 'Cheapest' },
  ...
  // ── Qwen3.5 ───────────────────────────────────────────────────────────────
  { model: 'Qwen3.5-9B',          provider: 'OpenRouter',  input: 0.04, output: 0.15, cache: 0.50, path: 'aggregator', notes: 'Cheapest' },
  ...
  { model: 'Gemma 3-12B', provider: 'DeepInfra',   input: 0.04, output: 0.13, cache: 0.50, path: 'aggregator', notes: 'Cheapest' },
  { model: 'Gemma 3-12B', provider: 'Fireworks',   input: 0.20, output: 0.20, cache: 0.50, path: 'aggregator' },
  { model: 'Gemma 3-4B',  provider: 'Together AI', input: 0.02, output: 0.04, cache: 0.50, path: 'aggregator', notes: 'Cheapest' },
  ...
  // ── Gemma 4 ───────────────────────────────────────────────────────────────
  { model: 'Gemma 4-31B',       provider: 'DeepInfra',   input: 0.12, output: 0.37, cache: 0.50, path: 'aggregator', notes: 'Cheapest' },
  { model: 'Gemma 4-31B',       provider: 'Together AI', input: 0.20, output: 0.50, cache: 0.50, path: 'aggregator' },
  { model: 'Gemma 4-26B (MoE)', provider: 'OpenRouter',  input: 0.06, output: 0.33, cache: 0.50, path: 'aggregator', notes: 'Cheapest' },
  ...
  { model: 'DeepSeek R1',                provider: 'OpenRouter',  input: 0.45,  output: 2.15,  cache: 0.50, path: 'aggregator', notes: 'Cheapest (R1-0528)' },
  { model: 'DeepSeek R1',                provider: 'Together AI', input: 3.00,  output: 7.00,  cache: 0.50, path: 'aggregator' },
  { model: 'DeepSeek V4 Flash',          provider: 'OpenRouter',  input: 0.126, output: 0.252, cache: 0.50, path: 'aggregator', notes: 'Cheapest' },
  { model: 'DeepSeek V4 Flash',          provider: 'Fireworks',   input: 0.14,  output: 0.28,  cache: 0.50, path: 'aggregator' },
  { model: 'DeepSeek V4 Pro',            provider: 'OpenRouter',  input: 0.435, output: 0.87,  cache: 0.50, path: 'aggregator', notes: 'Cheapest' },
  ...
  // ── Mistral ───────────────────────────────────────────────────────────────
  { model: 'Mistral Small 3.2', provider: 'OpenRouter',  input: 0.07,  output: 0.20, cache: 0.50, path: 'aggregator', notes: 'Cheapest' },
  { model: 'Mistral Small 3.2', provider: 'DeepInfra',   input: 0.075, output: 0.20, cache: 0.50, path: 'aggregator' },
  { model: 'Mistral Large 3',   provider: 'OpenRouter',  input: 0.50,  output: 1.50, cache: 0.50, path: 'aggregator', notes: 'Cheapest' },
